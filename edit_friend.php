...
$total_result = $dtb->query("select * from friends where seller_id={$seller_id} and id={$id}");
...
<form method="post" action="edit_friend_process.php"   data-parsley-validate novalidate>

  <div class="form-group row">
    
    <label for="inputEmail3" class="col-sm-2 col-form-label">Name</label>
    <div class="col-sm-10">
      <input type="text" name="name" required class="form-control" id="name" placeholder="Name" value="<?php echo $banner_data->name; ?>">
