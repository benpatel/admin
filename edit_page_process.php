...
$sql="UPDATE `pages` SET `page_title` = '{$page_title}',`page_subtitle` = '{$page_subtitle}', `page_description` = '{$page_description}',`page_image` = '{$page_image}', `visibility` = '{$visibility}' WHERE `pages`.`id` = {$page_id} AND seller_id ={$seller_id};
";
