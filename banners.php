    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="pull-right m-t-15">
                <a class="btn btn-success btn-white-text waves-effect waves-light" href="add_banner.php">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box" id="uploaded_banner_box">
            	...
            	<?php
            			$sql = "select * from banners where seller_id={$seller_id} order by sort desc";
				...
				?>
							...
							<?php
							   ...
							   <div class="banner_image" style="text-align: left;border:solid 1px #ccc; padding:5px;">
                                ...
                                <p><a href="edit_banner.php?id=<?php echo $result->id; ?>" class="btn btn-secondary">Edit</a> <span  class="btn btn-danger btn-delete-banner" data-id="<?php echo $result->id; ?>">Delete</span></p>
                               </div>
							   <?php
							      $x++;
