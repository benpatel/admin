...
<?php require 'includes/header_end.php'; ?>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="page-title">Fun Fact Manager</h4>
        </div>
    </div>
    <!-- end row -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                ...
                <div  id="fun_spec" >
                <?php
                        $sql = "select * from fun where seller_id={$seller_id} order by pos desc";
                ...
                ?>
                            ...
                            <?php
                               ...
                               ?>
                               <div class="fun_detail" data-fun="<?php echo $result->id; ?>" id="faq-id-<?php echo $result->id;?>">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="mySmallModalLabel"><i class="text-warning fa fa-lg fa-edit"> &nbsp;</i> <span style=""> Fun Spec</span></h5>
            ...
            <div class="modal-body">
                ...
                <form method="post" id="faq_form">
                    ...
                    <input type="hidden" id="faq_id" name="fun_id" value=""> 
...
<div class="modal fade delete-faq-modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="mySmallModalLabel"><i class="text-warning fa fa-lg fa-warning"></i> <span style="color:red">fun Spec</span></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>fun Spec will be deleted permanently</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
    ...
    $(document).ready(function() {
        ...
        $( "#fun_spec" ).sortable({
            ...
            update: function( event, ui ) {
               ...
               $(".fun_detail").each(function(e){
                    

                    fun_order.push($(this).data("fun"));
               });
                
            var data = {fun_order: fun_order};
